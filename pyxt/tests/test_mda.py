...
class MDATests(unittest.TestCase):
    ...
    def test_mem_write_byte_calls_char_generator_top_left(self):
        self.mda.mem_write_byte(0x0000, 0x41)
        self.assertEqual(self.cg.last_blit, (None, (0, 0), 0x41, EGA_GREEN, EGA_BLACK))
        
    def test_mem_write_byte_calls_char_generator_bottom_right(self):
        self.mda.mem_write_byte(3998, 0xFF)
        self.assertEqual(self.cg.last_blit, (None, (711, 336), 0xFF, EGA_GREEN, EGA_BLACK))
        
    def test_mem_write_byte_char_before_attribute(self):
        self.mda.mem_write_byte(3998, 0xFF)
        self.assertEqual(self.cg.last_blit, (None, (711, 336), 0xFF, EGA_GREEN, EGA_BLACK))
        self.mda.mem_write_byte(3999, MDA_ATTR_INTENSITY)
        self.assertEqual(self.cg.last_blit, (None, (711, 336), 0xFF, EGA_BRIGHT_GREEN, EGA_BLACK))
        
    def test_mem_write_byte_attribute_before_char(self):
        self.mda.mem_write_byte(3999, MDA_ATTR_INTENSITY)
        self.assertEqual(self.cg.last_blit, (None, (711, 336), 0x00, EGA_BRIGHT_GREEN, EGA_BLACK))
        self.mda.mem_write_byte(3998, 0xFF)
        self.assertEqual(self.cg.last_blit, (None, (711, 336), 0xFF, EGA_BRIGHT_GREEN, EGA_BLACK))
    ...
    def test_mem_write_word_at_top_left(self):
        ...
        self.assertEqual(self.cg.last_blit, (None, (0, 0), 0x41, EGA_BRIGHT_GREEN, EGA_BLACK))
    ...
    def test_mem_write_word_at_bottom_right(self):
        ...
        self.assertEqual(self.cg.last_blit, (None, (711, 336), 0x5A, EGA_BRIGHT_GREEN, EGA_BLACK))
