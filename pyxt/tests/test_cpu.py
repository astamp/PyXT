...
class MovOpcodeTests(BaseOpcodeAcceptanceTests):
    ...
    def test_mov_rm16_imm16_register(self):
        """
        mov cx, 0x5643
        hlt
        """
        self.cpu.regs.CX = 0x00
        # This is handcrafted since NASM will generate B9 43 56 F4.
        self.load_code_string("C7 C1 43 56 F4")
        self.assertEqual(self.run_to_halt(), 2)
        self.assertEqual(self.cpu.regs.CX, 0x5643)
        
    def test_mov_rm16_imm16_memory(self):
        """
        mov word [value], 0x5643
        hlt
        value:
            dw 0xAA55
        """
        self.load_code_string("C7 06 07 00 43 56 F4 55 AA")
        self.assertEqual(self.run_to_halt(), 2)
        self.assertEqual(self.memory.mem_read_word(7), 0x5643)
...
class AdjustFlagTests(BaseOpcodeAcceptanceTests):
    ...
    def test_dec_rm8_adjust_clear(self):
        """
        dec al
        hlt
        """
    ...
    def test_dec_rm8_adjust_set(self):
        """
        dec al
        hlt
        """
    ...
    def test_dec_rm16_adjust_clear(self):
        """
        dec word [value]
        hlt
        value:
        ...
        """
        self.cpu.flags.adjust = True
        self.load_code_string("FF 0E 05 00 F4 01 00")
        self.assertEqual(self.run_to_halt(), 2)
        self.assertEqual(self.memory.mem_read_word(0x0005), 0x0000)
        self.assertFalse(self.cpu.flags.adjust)
        
    def test_dec_rm16_adjust_set(self):
        """
        dec word [value]
        hlt
        value:
        ...
        """
        self.cpu.flags.adjust = False
        self.load_code_string("FF 0E 05 00 F4 00 00")
        self.assertEqual(self.run_to_halt(), 2)
